...
SegmenterVisualization::initialize (int argc, char ** argv)
{
  ...
  SaliencyPub_ = n_->advertise<sensor_msgs::Image>("/squirrel_segmentation_visualization_saliencymap", 1000);
  SegmentationPub_ = n_->advertise<sensor_msgs::Image>("/squirrel_segmentation_visualization_segmentation", 1000);
