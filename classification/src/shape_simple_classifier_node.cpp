  ...
  private:
                  ...
                  perception_srv_definitions::classify::Response & response)
    {
        ...
        for(size_t i=0; i < req.clusters_indices.size(); i++)
        {
          ...
          perception_msgs::classification class_tmp;
...
//          }
    ...
    bool segmentAndClassify(perception_srv_definitions::segment_and_classify::Request & req,
                               perception_srv_definitions::segment_and_classify::Response & response)
    {
      //------- Segmentation------------------
