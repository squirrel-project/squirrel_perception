...
#include "perception_srv_definitions/segment_and_classify.h"
...
private:
    ...
    std::vector< perception_msgs::classification> class_results_ros_;
    ...
    {
        ros::ServiceClient segmentation_client = n_->serviceClient<perception_srv_definitions::segment>("/object_segmenter_service/object_segmenter");
        perception_srv_definitions::segment seg_srv;
    ...
    {
        ros::ServiceClient classifierClient = n_->serviceClient<perception_srv_definitions::classify>("/classifier_service/classify");
        perception_srv_definitions::classify srv;
    ...
    {
        ros::ServiceClient segAndClassifierClient = n_->serviceClient<perception_srv_definitions::segment_and_classify>("/classifier_service/segment_and_classify");
        perception_srv_definitions::segment_and_classify srv;
        srv.request.cloud = *msg;
