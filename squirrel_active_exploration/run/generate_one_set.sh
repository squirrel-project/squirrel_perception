...
SAVE_DIRECTORY=/home/tpat8946/Data/TUW/Results/training_set_3
#DATA_DIRECTORY=/home/tpat8946/Data/TUW/TUW_dynamic_dataset_icra15/training_data/cisco_phone.pcd
DATA_DIRECTORY=/home/tpat8946/Data/TUW/TUW_GH30_dataset/GH30_set_003
ENTROPY_FILE_NAME=$SQUIRREL_DIRECTORY/data/config/entropy_order/training_set_3/GH30_set_003.txt
...
PLANS=(min_class_entropy_unoccluded)
START_INDEX_MAX=1
# Run
for (( s=1; s<=$START_INDEX_MAX; s++ ))
do
	for p in "${PLANS[@]}"
	do
